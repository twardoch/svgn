...
mod tests {
    ...
    fn test_collect_editor_prefixes() {
        ...
        svg_element.attributes.insert(
            "xmlns:normal".to_string(),
            "http://normal.namespace".to_string(),
        );
    ...
    fn test_remove_editor_attributes() {
        ...
        element
            .attributes
            .insert("sodipodi:nodetypes".to_string(), "cc".to_string());
        element
            .attributes
            .insert("inkscape:connector-curvature".to_string(), "0".to_string());
        element
            .attributes
        ...
        assert!(!element
            .attributes
            .contains_key("inkscape:connector-curvature"));
